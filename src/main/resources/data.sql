...
INSERT INTO courses (id, created_at, deleted_at, updated_at, course_name, description, grade, image, price, teacher_support, user_id, category_id)
  values (1,'2019-07-14 11:45:49.344428', null, '2019-07-14 11:45:49.344428', 'Математика','Курс математика, прикольно очень',9,'src/koe 4to',500.00,true,1,1);

INSERT INTO courses (id, created_at, deleted_at, updated_at, course_name, description, grade, image, price, teacher_support, user_id, category_id)
 values (2,'2019-07-14 11:45:49.344428', null, '2019-07-14 11:45:49.344428', 'Физика','Курс физика,прикольно очень',10,'src/koe 4to',600.00,true,2, 2);
...
INSERT INTO questions (id, created_at, deleted_at, updated_at, image, question, score, test_id)
 values (3,'2019-07-14 11:45:49.344428', null, '2019-07-14 11:45:49.344428', null, 'Ты далбаеб?', 2, 1);
...
INSERT INTO question_options (id, created_at, deleted_at, updated_at, answer, right_answer, question_id)
 values (5,'2019-07-14 11:45:49.344428', null, '2019-07-14 11:45:49.344428', 'Да', true, 3);

INSERT INTO question_options (id, created_at, deleted_at, updated_at, answer, right_answer, question_id)
 values (6,'2019-07-14 11:45:49.344428', null, '2019-07-14 11:45:49.344428', 'Нет', true, 3);
